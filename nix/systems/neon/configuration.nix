...

{
  ...
  boot.initrd.luks.devices."luks-ddc7c20b-f821-4f09-938a-a5f11b278d2b".device = "/dev/disk/by-uuid/ddc7c20b-f821-4f09-938a-a5f11b278d2b";
  ...
  # Set nixos-config in NIX_PATH to the current file
